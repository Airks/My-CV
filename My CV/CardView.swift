...
class CardView: UIView {
    ...
    var desc: String = "Une longue description pour test le truc lmao !"
    ...
    override func layoutSubviews() {
        ...
        descriptionLabel.frame.origin = bounds.origin.offsetBy(dx: 0, dy: 20)
    }
...
extension CardView {
    private struct SizeRatio {
        ...
        static let offsetToUpperBound: CGFloat = 0.33
